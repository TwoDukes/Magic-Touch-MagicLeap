...
namespace MagicLeap
{
    ...
    public class HandTrackingVisualizer : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("The Gameobject that will sit at the end of each index finger")]
        private GameObject _affector;
        ...
        void Update()
        {
            if (MLHands.IsStarted)
            {
                ...
                //{
                    _indexFinger[0].position = Hand.Index.KeyPoints[0].Position;
                //}
        ...
        private void Initialize()
        {
            ...
            //for (int i = 0; i < Hand.Index.KeyPoints.Count; ++i)
            //{
                _indexFinger.Add(CreateAttractorPoint(Hand.Index.KeyPoints[0]).transform);
            //}
        ...
        private GameObject CreateAttractorPoint(MLKeyPoint keyPoint)
        {
            GameObject newObject;
            
            newObject = Instantiate(_affector);
            newObject.transform.SetParent(transform);
            newObject.name = "IndexAffector";
